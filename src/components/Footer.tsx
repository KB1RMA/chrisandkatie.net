/**
 * Site footer with a link to the GitHub source repository and a witty copyright line.
 * Uses a monospaced font to give it a developer-flavored look that matches the site theme.
 */

const GITHUB_REPO_URL = 'https://github.com/KB1RMA/chrisandkatie.net';
const COPYRIGHT_YEAR = new Date().getFullYear();

export function Footer() {
  return (
    <footer className="mt-auto w-full bg-gray-900 px-4 py-4 font-mono text-xs text-gray-400">
